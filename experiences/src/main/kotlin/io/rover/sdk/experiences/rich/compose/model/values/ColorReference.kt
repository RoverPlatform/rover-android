...
internal sealed class ColorReference {
    ...
    data class DocumentColor(
        ...
        @Transient var documentColor: io.rover.sdk.experiences.rich.compose.model.values.DocumentColor? = null
    ) : ColorReference() {
        override fun setRelationships(documentColors: Map<String, io.rover.sdk.experiences.rich.compose.model.values.DocumentColor>) {
    ...
    open fun setRelationships(
        documentColors: Map<String, io.rover.sdk.experiences.rich.compose.model.values.DocumentColor>
    ) {
        // no-op.
    }
}
