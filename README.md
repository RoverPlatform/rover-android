...
dependencies {
    // ...
    implementation "io.rover:core:2.2.3"
    implementation "io.rover:notifications:2.2.3"
    implementation "io.rover:experiences:2.2.3"
    implementation "io.rover:location:2.2.3"
    implementation "io.rover:debug:2.2.3"
}
```
