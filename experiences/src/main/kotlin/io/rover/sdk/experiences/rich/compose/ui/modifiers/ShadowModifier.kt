...
@Composable
internal fun ExperiencesShadowModifier(
    shadow: Shadow?,
    modifier: Modifier,
    content: @Composable (modifier: Modifier) -> Unit
) {
    if (shadow != null) {
        // instead of using .experiencesShadow() *directly* on our content, instead we'll use
        ...
        Layout({
            ...
            Layout(
                ...
                modifier = Modifier
                    .experiencesShadow(Environment.LocalNode.current, shadow, Environment.LocalIsDarkTheme.current)
...
internal fun Modifier.experiencesShadow(node: Node?, shadow: Shadow, isDarkMode: Boolean) = this
    .then(
        when (node) {
            ...
            is Rectangle, null -> drawBehind {
                drawIntoCanvas { canvas ->
                    ...
                    // Adjust shadow size to better match iOS
