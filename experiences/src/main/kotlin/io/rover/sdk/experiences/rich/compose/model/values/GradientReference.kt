...
internal sealed class GradientReference {
    ...
    data class DocumentGradient(
        ...
        @Transient var documentGradient: io.rover.sdk.experiences.rich.compose.model.values.DocumentGradient? = null
    ) : GradientReference() {
        override fun setRelationships(documentGradients: Map<String, io.rover.sdk.experiences.rich.compose.model.values.DocumentGradient>) {
    ...
    open fun setRelationships(
        documentGradients: Map<String, io.rover.sdk.experiences.rich.compose.model.values.DocumentGradient>
    ) {
        // no-op.
    }
}
