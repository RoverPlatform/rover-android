...
import io.rover.sdk.experiences.platform.imageView
import io.rover.sdk.experiences.platform.linearLayout
import io.rover.sdk.experiences.platform.relativeLayout
...
import io.rover.sdk.experiences.platform.view
import io.rover.sdk.experiences.platform.votingIndicatorBar
...
internal class ImagePollOptionView(context: Context?) : RelativeLayout(context) {
    ...
    private fun performResultsAnimation(votingShare: Int, isSelectedOption: Boolean) {
        ...
        resultsAnimation = AnimatorSet().apply {
            playTogether(
                alphaAnimator,
                whiteVotingBarAlphaAnimator,
                overlayAlphaAnimator,
                resultProgressFillAnimator,
    ...
    private fun bindVotePercentageText(votingShare: Int) {
        votePercentageView.run {
            ...
            setupRelativeLayoutParams(
                width = RelativeLayout.LayoutParams.WRAP_CONTENT,
                height = 24.dpAsPx(resources.displayMetrics)
            ) {
