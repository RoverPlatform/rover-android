...
import io.rover.campaigns.experiences.data.events.Poll
import io.rover.campaigns.experiences.data.events.RoverEvent
import io.rover.campaigns.experiences.data.getFontAppearance
...
import io.rover.campaigns.experiences.streams.Timestamped
import io.rover.campaigns.experiences.streams.distinctUntilChanged
...
import io.rover.campaigns.experiences.streams.timestamp
...
internal class ImagePollViewModel(
    ...
    override fun intrinsicHeight(bounds: io.rover.campaigns.experiences.ui.RectF): Float {
