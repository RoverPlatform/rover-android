...
/**
 * Tests for PostsSync cursor-based pagination logic
 *
 ...
 * - Empty page handling
 */
class PostsRepositoryPaginationTest : RoverEngageTestBase() {
    ...
    fun testEmptyPageHandling() = runTest {
        ...
        // Then: Sync should succeed even when no posts are retrieved
        assert(result) { "Sync should return true when the request succeeds with no posts" }
