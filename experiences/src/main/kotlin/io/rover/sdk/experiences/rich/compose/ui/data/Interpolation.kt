...
/**
 * This class handles the interpolation of the Experiences expression language.
...
internal class Interpolator(
    ...
    fun interpolate(theTextToInterpolate: String): String? {
        return try {
            ...
            if (exception is StringExpressionException || exception is java.lang.NumberFormatException) {
                ...
                android.util.Log.e(
                    io.rover.sdk.experiences.rich.compose.ui.data.Interpolator.Companion.TAG,
    ...
    /**
     * Interpolates a [String] containing expressions in the Experiences expression language.
