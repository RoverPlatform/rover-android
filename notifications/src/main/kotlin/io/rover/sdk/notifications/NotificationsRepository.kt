...
import io.rover.sdk.core.streams.doOnComplete
import io.rover.sdk.core.streams.doOnNext
import io.rover.sdk.core.streams.filterForSubtype
...
class NotificationsRepository(
    ...
    private val stateStoreObserverChain = syncCoordinator.syncResults.flatMap { syncResult ->
        ...
        when (syncResult) {
            io.rover.sdk.core.data.sync.SyncCoordinatorInterface.Result.Succeeded -> Publishers.just(NotificationsRepositoryInterface.Emission.Event.Refreshing(false))
            else -> {
                listOf(
