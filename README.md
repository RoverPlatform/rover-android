...
dependencies {
    // ...
    implementation "io.rover:core:2.1.5"
    implementation "io.rover:notifications:2.1.5"
    implementation "io.rover:experiences:2.1.5"
    implementation "io.rover:location:2.1.5"
    implementation "io.rover:debug:2.1.5"
}
```
